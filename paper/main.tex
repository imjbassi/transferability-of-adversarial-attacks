...
Papernot et al.\ and Liu et al.\ established practical transfer-based black-box evaluations \cite{papernot,liu}. Directionality and optimization-dependent transfer are established phenomena \cite{demontis,dong}. Conditioning on both clean correctness and successful source attacks is not new: Inkawhich et al.\ explicitly use these conditions for their untargeted transfer evaluation \cite{inkawhich2019}. Our question concerns reporting sufficient to reconstruct CTR, never whether a named paper is wrong.

This framework complements general robustness-evaluation guidance \cite{carlini2019,tramer2020}, AutoAttack \cite{croce2020}, and RobustBench \cite{robustbench}; none of those benchmarks is claimed to have been run here. The mathematical setup concerns untargeted attacks against classifiers with compatible labels. Tangential corpus matches, including other tasks and surveys, need an explicit applicability ledger before substantive interpretation.
...
\bibitem{inkawhich2019} N. Inkawhich, W. Wen, H. H. Li, and Y. Chen. Feature Space Perturbations Yield More Transferable Adversarial Examples. CVPR, pp. 7066--7074, 2019.
\bibitem{wu2020} W. Wu, Y. Su, X. Chen, S. Zhao, I. King, M. R. Lyu, and Y.-W. Tai. Boosting the Transferability of Adversarial Samples via Attention. CVPR, pp. 1161--1170, 2020.

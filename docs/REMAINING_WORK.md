...
Status at 24 September 2026, after completing ranks 1-16 and 38. The manuscript is **not publication-ready**.
...
- Ranks 12-16 reviewed; ranks 13 and 16 flagged as recomputation candidates (`artifact_review: candidate_release_sufficiency_unverified`).
- Eighteen of 80 full evidence reviews complete; none partial; 62 pending. These are workflow counts, not survey findings.

## Required before defensible survey claims

1. **Finish 62 evidence reviews:** review the remaining 62 papers, including supplements, all result scopes, six judgments, evidence locators, applicability, artifact checks and bounds eligibility. Preserve unclear versus explicit no and all positive conditioning evidence. Keep the original corpus/scheme/tag immutable; the September 23 amendment is retrospective.
